...
define('BACKEND_TITLE','格蘭傑私藏 後台');
define('SERVER_URL','http://www.glenmorangie-etiquette.com/');

//基本設定
define('projectName', 'glenmorangie_keep'); //專案名
define('ctrl_main','Companta'); //controll name
...
define('fans_page'      ,is_https.'://www.facebook.com/TaiwanGlenmorangie'); 
define('fans_page_id'   ,'350506288344014');
